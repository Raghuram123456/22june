  ...
  return (
    <div className="font-[Poppins]">
      ...
      <div className="pl-[15%] pr-[15%] pt-20 bg-slate-30 min-h-[calc(100vh)]">
        <p className="text-justify pt-[50px] text-[20px] font-medium ">
          New Cars
        </p>
        <br />

        <p>
          Are you planning on buying a new car? Well, we know that with so many
          options available out there, it gets really difficult to find a good
          car which suits your need. Hence, we have put together a complete list
          of new cars. Maruti Suzuki, Tata and Hyundai are the 3 most popular
          car brands. The 5 most popular cars are Maruti Suzuki Fronx, Tata
          Nexon, Mahindra Scorpio N, Tata Punch and Mahindra Thar.
          <br />
          <button
          ...
          {buttonClicked && (
            <div>
              <p className="pt-[50px] text-[17px] font-medium ">
                Upcoming Cars Price List (December 2023) in India
              </p>
              <div className="overflow-x-auto text-black">
                ...
                >
                  <tr className="bg-gray-200" align="left">
                    <td className="cursor-pointer border border-slate-700 px-6 py-2">
                      MODEL
                    </td>
                    <td className="cursor-pointer border border-slate-700 px-6 py-2">
                      EXPECTED PRICE
        ...
        <p className="pt-[30px] text-[17px] font-medium">
          New Car Launch in India 2023 - All details
        </p>
        <br />
        <form className="">
          <tr>
